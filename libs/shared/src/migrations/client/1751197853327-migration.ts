...
export class Migration1751197853327 implements MigrationInterface {
  name = 'Migration1751197853327';

  public async up(queryRunner: QueryRunner): Promise<void> {
    const { schema } = queryRunner.connection
      .options as PostgresConnectionOptions;
    await queryRunner.query(
      `CREATE TABLE "${schema}"."addresses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT 'now()', "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT 'now()', "deleted_at" TIMESTAMP, "address" character varying(200) NOT NULL, "postalCode" character varying(20) NOT NULL, "city" character varying(100) NOT NULL, "country" character varying(100) NOT NULL, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "${schema}"."users" ALTER COLUMN "updated_at" SET DEFAULT '2025-04-13 21:49:58.976695+00'`,
    );
    await queryRunner.query(
      `ALTER TABLE "${schema}"."users" ALTER COLUMN "created_at" SET DEFAULT '2025-04-13 21:49:58.976695+00'`,
    );
    await queryRunner.query(
